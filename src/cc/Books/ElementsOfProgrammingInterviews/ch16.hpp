...
#ifndef Books_ElementsOfProgrammingInterviews_ch16_hpp
#define Books_ElementsOfProgrammingInterviews_ch16_hpp
...
namespace study {
  ...
  extern std::vector<std::unique_ptr<BSTNode<int>>> GenerateAllBinaryTrees(int num_nodes);
  ...
  extern int ComputeDiameter(const std::unique_ptr<BSTNode<int>> &tree);

}

#endif // Books_ElementsOfProgrammingInterviews_ch16_hpp
